...
function setup() {
	...
	boxbottom = Bodies.rectangle(width/2,645,200,20,{isStatic:true});
  World.add(world,boxbottom)

boxright = Bodies.rectangle(500,605,20,100,{isStatic:true});
World.add(world,boxright);

boxleft = Bodies.rectangle(300,605,20,200,{isStatic:true});
